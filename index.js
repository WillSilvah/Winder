...
client.functionManager.createFunction({
    ...
    type: "aoi.js",
    code: `$get[tempmsgs]
$let[tempmsgs;$truncate[$math[$get[tempmsgssoma]/$membersCount[$guildID;all;false]]]]
$let[tempmsgssoma;$math[$replaceText[$replaceText[$userLeaderBoard[$guildID;messageMonth;desc;{value},;$membersCount[$guildID;all;false];1;main];,;+];+
;+]0]]`
});
