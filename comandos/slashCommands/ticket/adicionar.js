...
$setChannelVar[messageLogTicket;$hour[TwoDigit]:$minute[TwoDigit]:$second[TwoDigit] - $day[TwoDigit]/$month[TwoDigit] -> $userTag[$clientID] ($clientID): $userTag ($authorID) adicionou $userTag[$get[userID]] ($get[userID]) ao ticket!\n$getChannelVar[messageLogToday]]
