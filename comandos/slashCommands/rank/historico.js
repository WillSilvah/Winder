...
> 💬 $separateNumber[$env[data;value];.] ✨️ $separateNumber[$getMemberVar[pdaTotal;$env[data;id];$guildID;0].] ⬆️ $getMemberVar[votesTotal;$env[data;id];$guildID;0] 🔥$getMemberVar[talkingTotal;$env[data;id];$guildID;0]]]
]
