...
> 💬 $separateNumber[$env[data;value];.] ✨️ $separateNumber[$getMemberVar[pdaMonth;$env[data;id];$guildID;0];.] ⬆️ $getMemberVar[votesMonth;$env[data;id];$guildID;0] 🔥$getMemberVar[talkingMonth;$env[data;id];$guildID;0]]]
]
