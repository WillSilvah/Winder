...
$if[$hasRoles[$guildID;$get[userID];1481734062270844968]==true;👻 É um peludo assombrado]
$if[$getMemberVar[talkingMonth;$get[userID];$guildID;0]>=7;🗣 Conversou por mais de sete dias na comunidade neste mês!]
$if[$getMemberVar[minigameMonthWins;$get[userID];$guildID;0]>=5;🎮 Ganhou mais de cinco minigames este mês!]
