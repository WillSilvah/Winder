module.exports = [{
    ...
    $if[$includes[$toLowercase[$message];compartilhar;permissão;como;enviar;mandar;envio]|$includes[$toLowercase[$message];image;mídia;midia;arte;foto;photo;anexo;vídeo]==true|true;
