module.exports = [{
    type: "guildMemberAdd",
    code: `
    $onlyIf[$includes[$userDisplayName / $nickname / $userTag;卐;卍;࿕;࿖;࿗;࿘;ꖦ;ᛋ;ϟ;ᛋᛋ;clatebit;🇮🇱;trading;platform;Zeta;ζ;φ;$USD;cavetodex]==true] $c[Verifica se o nome do usuário tem os caracteres e termos, se sim, executa o banimento]
