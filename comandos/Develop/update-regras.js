...
$description[4;
$addField[4;Respeito;- A Patinhas valoriza os valores humanos, é proibido palavrões em excesso, desrespeito, preconceito, intolerância, xenofobia, extremismo (ou referências e relacionados à isso).]
]
$color[4;Cyan]

$description[5;
$addField[5;Conteúdos inadequados;- Não poste conteúdo NSFW, Gore (ou referências e relacionados a isso) ou mensagens que não condizem com o canal. Vale lembrar que não é permitido divulgação do que quer que seja (nome de usuário, canais de texto e etc) sem autorização prévia.]
]
$color[5;Red]
